/*
 * File: receiver.c
 * Created on: Friday, 2023-10-06 @ 14:36:36
 * Author: HackXIt (<hackxit@gmail.com>)
 * -----
 * Last Modified: Friday, 2023-10-06 @ 14:44:39
...
int main(int argc, char *const argv[])
{
	...
	do
	{
		ipc = block_semaphore(rb.sem_read); // Lock read semaphore
		character = rb.memory[read_index];
		ipc = free_semaphore(rb.sem_write); // Unlock write semaphore
		read_index++;
